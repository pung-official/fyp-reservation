...
public class password_reset2 extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;
    password_reset2(Context ctx) {
        context = ctx;
    }
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            String login_url = "http://istay.000webhostapp.com/homestay/reset_password.php";
