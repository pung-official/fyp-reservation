...
public class homestay_list_melaka extends AppCompatActivity {

    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    public static final String URL_PRODUCTS = "http://istay.000webhostapp.com/homestay/member_view_homestay_melaka.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            homestay_list_adapter adapter = new homestay_list_adapter(homestay_list_melaka.this, homestay_list_content);
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(homestay_list_melaka.this,MainActivity.class);
